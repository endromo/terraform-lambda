...
4. Create static and dynamic aliases for AWS Lambda Function.
5. Do complex deployments (eg, rolling, canary, rollbacks, triggers).
...
- Support integration with other serverless modules.
...
```hcl
locals {
  package_url = "examples/fixtures/python-zip/existing_package.zip"
